...
2) обработка ошибок в Result или  throws ?  разница есть? или вкусовшина?
3) API покрывать протоколом и делать DI избыточно?
4) Протоколы в отдельные файлы  выносить? как принято? 
""")
