...
struct PlayerButtonsShape: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        path.addCurve(
            to: CGPoint(x: 0.62307*width, y: 0.0376*height),
            control1: CGPoint(x: 0.44599*width, y: -0.00493*height),
            control2: CGPoint(x: 0.54374*width, y: -0.00493*height)
        )
        path.addLine(
            to: CGPoint(x: 0.86074*width, y: 0.16502*height)
        )
        path.addCurve(
            to: CGPoint(
                x: 0.98894*width,
            ...
            control1: CGPoint(x: 0.94007*width, y: 0.20755*height),
            control2: CGPoint(x: 0.98894*width, y: 0.28615*height)
        )
        path.addLine(
            to: CGPoint(x: 0.98894*width, y: 0.62605*height)
        )
